...
export function ChatItem({ conversation, isActive, onSelect, onDelete, onRename, onTogglePin }: ChatItemProps) {
    ...
    >
      ...
      <div className="flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity">
        ...
        <button
          ...
          className="p-1 rounded hover:bg-red-900/50 hover:text-red-400 transition-colors text-neutral-500"
          title="Delete"
        >
